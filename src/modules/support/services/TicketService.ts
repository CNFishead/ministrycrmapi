...
export default class TicketService extends CRUDService {
  ...
  public getMessages = asyncHandler(async (req: Request, res: Response): Promise<Response> => {
    try {
  ...
  public createMessage = asyncHandler(async (req: Request, res: Response): Promise<Response> => {
    try {
      const ticketId = req.params.id;
